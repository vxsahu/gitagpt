...
const Home: NextPage = () => {
  ...
  const prompt =
    language === "Funny"
      ? `You are Krishna, answer according to the 18 chapters and 700 verses of the Bhagavad Gita, which contains life lessons on morality, strength, discipline and spirituality: ${bio}${
          bio.slice(-1) === "." ? "" : "."
        }`
